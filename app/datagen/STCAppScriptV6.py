...
class DataGenerationScript:
    ...
    def __Apply_functions(self, df, op_1, k4_1):
        ...
        #        if self.params.get_ACC_RAND():
        if False:
            self.__apply_function(df, "ACC", "ACC", lambda x: generate_4_Digit())
        else:
    ...
    # ===================SET=====================#
    # ===========================================#
    def __SET_ALL_DISP_PARAMS(self):
        self.params.set_K4(
        ...
        self.params.set_PRODUCTION_CHECK(True)
    ...
    #             return "Loaded Json Unsuccessfull!"
...
# (
#     s.dataframes.set_ELECT_DF,
#     s.dataframes.set_GRAPH_DF,
#     s.dataframes.set_SERVER_DF,
#     s.dataframes.set_KEYS(),
# ) = s.preview_files_gets()
...
print(dec_iccid("982922334364000010F5"))